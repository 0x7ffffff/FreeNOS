...
teken_state_2(teken_t *t, teken_char_t c) {
    ...
    switch (c) {
        ...
        case 'H': /* CUP: Cursor Position */
            teken_subr_cursor_position(t, (t->t_curnum < 1 || t->t_nums[0] == 0) ? 1 : t->t_nums[0],
                                       (t->t_curnum < 2 || t->t_nums[1] == 0) ? 1 : t->t_nums[1]);
            break;
        ...
        case 'r': /* DECSTBM: Set top and bottom margins */
            teken_subr_set_top_and_bottom_margins(t, t->t_curnum < 1 ? 0 : t->t_nums[0],
                                                  t->t_curnum < 2 ? 0 : t->t_nums[1]);
            break;
